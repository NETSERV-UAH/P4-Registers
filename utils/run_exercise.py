...
class ExerciseTopo(Topo):
    ...
    def __init__(self, hosts, switches, links, log_dir, **opts):
        ...
        for link in host_links:
            ...
            self.addHost(host_name, ip=host_ip+'/8', mac=host_mac)
...
class ExerciseRunner:
    ...
    def run_exercise(self):
        ...
        self.program_hosts() #modifica los host a su antojo!!!
    ...
    def program_hosts(self):
        ...
        for host_name in self.topo.hosts():
            ...
            #w_iface = link.intf1 if link.intf1 != h_iface else link.intf2
